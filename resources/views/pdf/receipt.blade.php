    ...
    <div class="px-8 py-12 max-w-3xl mx-auto">
        ...
        <div class="border-b border-gray-200 pb-8 mb-8">
            ...
            <div class="grid grid-cols-2 gap-8">
                <div>
                    <div class="text-gray-600 mb-3"><span class="font-semibold text-gray-700">Name:</span>
                        {{ $user->name }}
                    </div>
                    <div class="text-gray-600 mb-3"><span class="font-semibold text-gray-700">Email:</span>
                        {{ $user->email }}</div>
                    <div class="text-gray-600"><span class="font-semibold text-gray-700">NIF:</span>
                        {{ $order->nif ?? 'N/A' }}</div>
                </div>
                <div>
            ...
            <tbody>
                @foreach ($items as $item)
                    <tr class="border-b border-gray-100">
                        ...
                        <td class="py-4 px-2 text-gray-600 text-right">€{{ number_format($item['discount'] ?? 0, 2) }}
                        </td>
                        <td class="py-4 px-2 text-gray-800 font-medium text-right">
