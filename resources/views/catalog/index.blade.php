            ...
            @foreach ($products as $product)
                <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        ...
                        <p class="text-gray-600 text-sm mb-4">{{ Str::limit($product->description, 200) }}</p>
                        <div class="mt-auto">
                            <span class="text-xl font-bold block mb-3 text-black">${{ number_format($product->price, 2) }}</span>
