...
<flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 h-18">
    ...
    <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
        ...
        <flux:tooltip :content="__('Toggle Dark Mode')" position="bottom">
            <flux:navbar.item
                class="h-10 max-lg:hidden [&>div>svg]:size-5 cursor-pointer"
                x-data
