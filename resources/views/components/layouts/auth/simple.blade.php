...
<body class="min-h-screen bg-white font-sans antialiased dark:bg-gradient-to-b dark:from-neutral-950 dark:to-neutral-900 text-neutral-900 dark:text-neutral-100">
<main class="flex min-h-svh flex-col items-center justify-center px-4 py-8 md:py-12">
    <div class="w-full max-w-md space-y-8 rounded-2xl bg-background/60 backdrop-blur p-6 shadow-xl md:p-10 border border-white/10">
        <!-- Branding -->
        <a href="{{ route('home') }}" class="flex flex-col items-center gap-2 font-semibold text-lg hover:opacity-80 transition" wire:navigate>
            <div
